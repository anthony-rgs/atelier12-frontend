...
let commentList = [
  ...
  },
  {
    name: 'Charlie Verne',
    commentary:
      "<span class='apostrophe'>“ </span>C'est toujours un plaisir de se faire couper les cheveux ici. J'ai pour habitude de traverser Paris pour venir, et j'en ressors toujours beau comme un camion (mais attention, un camion de luxe). <br> Je recommande vivement à toutes celles et ceux cherchant une qualité de service exceptionnelle à un bon prix.<span class='apostrophe'> “</span> ",
  },
  {
    name: 'Claire Dravert',
    commentary:
